...
//    Button logout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_daily_meal, R.id.nav_favourite,R.id.nav_my_cart,R.id.nav_about_us,R.id.nav_contact_us)
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.myOrders:
                Intent intent=new Intent(MainActivity.this, MyCartFragment.class);
                //startActivity(intent);
        }
